...
public class SlotController {
    ...
    @GetMapping
    public ResponseEntity<List<Slot>> getSlotsByDate(@RequestParam LocalDate date) {
    ...
    public ResponseEntity<Slot> reserveSlot(@PathVariable Long slotId) {
        Slot reservedSlot = slotService.reserveSlot(slotId);
