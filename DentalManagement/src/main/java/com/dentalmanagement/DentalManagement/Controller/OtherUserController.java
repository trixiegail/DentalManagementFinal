...
public class OtherUserController {
    ...
    public ResponseEntity<OtherUserEntity> updateUser(@PathVariable int id, @RequestBody OtherUserEntity newUserDetails, @RequestBody OtherUserEntity currentUser) {
        try {
