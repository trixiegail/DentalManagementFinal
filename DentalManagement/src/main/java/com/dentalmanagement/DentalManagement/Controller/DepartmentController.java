...
public class DepartmentController {
	...
	public DepartmentEntity updateDepartment(@RequestParam long id, @RequestBody DepartmentEntity newDepartmentDetails) {
	...
	@GetMapping("/search")
	public List<DepartmentEntity> searchDepartment(@RequestParam String keyword) {
	     return deptserv.searchDepartment(keyword);
	}
}
